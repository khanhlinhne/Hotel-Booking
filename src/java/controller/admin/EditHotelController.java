...
public class EditHotelController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Hotel hotel = new HotelDBContext().getHotelById(id);
        request.setAttribute("hotel", hotel);
        request.getRequestDispatcher("/view/admin/editHotel.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isActive = request.getParameter("isActive").equalsIgnoreCase("1");
