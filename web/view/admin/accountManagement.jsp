                            ...
                            <td>${acc.role}</td>
                             <td>
                                 <form action="changerole" method="Post">
                                     <input hidden="" name="username" value="${acc.username}"/>
                                     
                                     <button type="submit" name="changeRole" value="${acc.role eq 'admin'?'user':'admin'}" class="btn btn-primary change-role-button" data-username="John">Change Role</button>
