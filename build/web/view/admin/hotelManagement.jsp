...
<html>
    ...
    <style>
        ...
        .table {
            margin-top: 2em; /* Adjust the value to control the amount of space below the table */
}
    </style>
    <body>
        <div class="sidebar">
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <a href="addhotel" class="btn btn-primary mt-4">Add Hotel</a>
                <table class="table table-hover table-bordered ">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.hotels}" var="h">
                        <tr>
                            <td>${h.name}</td>
                            <td><img style="width: 150px; height: 100px" src="${h.image}"/></td>
                            <td>${h.address}</td>
                            <td>${h.phone}</td>
                            <td>${h.isActive}</td>
                            <td><a href="edithotel?id=${h.id}" class="btn btn-primary">Edit</a></td>
                            <td><a href="hoteldetail?id=${h.id}" class="btn btn-primary">Detail</a></td>
