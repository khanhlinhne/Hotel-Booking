    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <a href="addroom?hotelid=${requestScope.hotelId}" class="btn btn-primary mt-4">Add Rooms</a>
                <table class="table table-hover table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>${r.name}</td>
                            <td><img style="width: 150px; height: 100px" src="${r.image}"/></td>
                            <td>${r.area}</td>
                            <td>${r.price}</td>
                            
                            
                            <td><a href="deleteroom?hotelid=${r.hotelId}&&id=${r.id}" class="btn btn-primary">Delete</a></td>
